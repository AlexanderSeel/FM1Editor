...
The current reviewed official FM-1 PC-firmware baseline is **V15 · 2026-07-30**. Physical FM-1 sessions must first re-check the official download center and record the exact firmware under test; see [`docs/research/fm1-firmware-baseline.md`](./docs/research/fm1-firmware-baseline.md). A newer firmware publication does not by itself validate any MIDI/audio/protocol behavior.
