...
describe('SpiegeLib MFCC Python 3.7.7 + Librosa 0.7.2 compatibility',()=>{
  it('matches all 572 reference coefficients within the strict admission tolerance',()=>{
    ...
    console.log(`MFCC admission maxError=${max} rms=${rms}`)
