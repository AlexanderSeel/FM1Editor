...
Source commit: `843458022fb5aa7122e68f7354aa26f122346083`
...
The mounted Audio → FM flow performs local reference preparation, Quick-scan retrieval and explicit seeded CMA-ES refinement. The acceptance runner reads numeric structural distance metadata from refined result cards, requires at least one improvement, measurable dry refined audition, no implicit editor load, explicit Load refined, zero Web MIDI requests and no external/write fetches.
