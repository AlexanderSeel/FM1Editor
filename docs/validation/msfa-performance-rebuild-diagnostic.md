# MSFA performance rebuild diagnostic

Diagnostic source commit: `6e75e837fc8595387306485fe2e3c4f48a4bd513`
...
bash: line 1: scripts/build-msfa-spike.sh: Permission denied
BUILD_RC=126

```

This is diagnostic evidence only; it does not validate or publish a new WASM artifact.
