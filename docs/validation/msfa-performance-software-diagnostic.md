# MSFA generated performance package software diagnostic

Diagnostic source commit: `677de54e96355934026f1dc84110892779a45f47`
...
[1m[30m[46m RUN [49m[39m[22m [36mv4.1.10 [39m[90m/home/runner/work/FM1Editor/FM1Editor[39m
 ...
 [32m✓[39m src/sysex/dx7.test.ts [2m([22m[2m9 tests[22m[2m)[22m[32m 34[2mms[22m[39m
 [32m✓[39m src/audio/msfaAudioWorklet.test.ts [2m([22m[2m10 tests[22m[2m)[22m[32m 22[2mms[22m[39m
 [32m✓[39m src/audio/msfaOfflineEngine.test.ts [2m([22m[2m6 tests[22m[2m)[22m[32m 30[2mms[22m[39m
 ...
 [32m✓[39m src/sysex/dx7.property.test.ts [2m([22m[2m5 tests[22m[2m)[22m[33m 737[2mms[22m[39m
     [33m[2m✓[22m[39m round-trips generated 32-voice banks on every MIDI channel [33m 388[2mms[22m[39m
 [32m✓[39m scripts/catalog-release-audit.test.mjs [2m([22m[2m5 tests[22m[2m)[22m[32m 27[2mms[22m[39m
 ...
 [32m✓[39m src/audio/msfaVoiceBridge.test.ts [2m([22m[2m4 tests[22m[2m)[22m[32m 13[2mms[22m[39m
 ...
 [32m✓[39m src/midi/fm1BankTransfer.test.ts [2m([22m[2m4 tests[22m[2m)[22m[32m 16[2mms[22m[39m
 ...
 [32m✓[39m src/components/AlgorithmGraph.test.ts [2m([22m[2m2 tests[22m[2m)[22m[32m 57[2mms[22m[39m
 ...
 [32m✓[39m src/catalog/trackedArchive.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 299[2mms[22m[39m
...
[2m   Duration [22m 4.14s[2m (transform 1.04s, setup 0ms, import 2.14s, tests 2.05s, environment 8ms)[22m
...
dist/assets/index-BYCkqpiR.css   66.95 kB │ gzip:  12.91 kB
dist/assets/index-CyhcZ0tY.js   459.75 kB │ gzip: 133.24 kB

[32m✓ built in 304ms[39m
Service worker generated with 7 precached URLs (b0c02bce53f640ca).
RC=0

```

This diagnostic does not publish generated artifacts or establish browser acceptance.
