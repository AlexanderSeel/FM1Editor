...
Overall admission/reproduction gate: **SUCCESS**
...
| Magenta DDSP | `cf5e62dfe5d5c80aa14761832233a2e68e840e53` | Apache-2.0 | SUCCESS with documented legacy toolchain constraints | pretrained models/datasets require separate license+hash | no |
